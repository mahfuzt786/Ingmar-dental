...
class SchemaInterdentalGapHandlingMixin {
    ...
    // function all_interdental_gaps($region=NULL) {
    //     /*"""
    ...
    // function biggest_interdental_gap($region=Region.whole_mouth()) {
    ...
    // function interdental_gap($region) {
    //     /*"""
    ...
    // function interdental_gaps($region) {
    //     /*"""
    //     Check if there is an interdental gap in some specific region. If there are,
    ...
    // function interdental_gap_with_to_be_replaced_count($region, $count) {
    //     /*"""
    ...
    // function neighboring_gap($obj, $region=Region.whole_mouth()) {
    //     /*"""
...
class SchemaRegionIdentifierHandlingMixin {
    ...
    // Upper Jaw
    //@property
    function upper_jaw_left_free_end() {
        /*"""
    ...
    //@property
    function upper_jaw_right_free_end() {
        /*"""
    ...
    // Mandible
    //@property
    function mandible_left_free_end() {
        /*"""
        ...
        if ($four_free_end->to_be_replaced_count == 40)
            return $four_free_end;
    ...
    //@property
    function mandible_right_free_end() {
        /*"""
